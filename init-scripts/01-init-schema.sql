...
-- 由於外鍵約束，我們需要暫時禁用它們
ALTER TABLE pf_demo_user DISABLE TRIGGER ALL;

INSERT INTO pf_demo_user (
...
-- 啟用觸發器
ALTER TABLE pf_demo_user ENABLE TRIGGER ALL;
...
(
    ...
    CONSTRAINT fk_customer_created_by FOREIGN KEY (created_by) REFERENCES pf_demo_user(id),
    CONSTRAINT fk_customer_modified_by FOREIGN KEY (modified_by) REFERENCES pf_demo_user(id)
);
